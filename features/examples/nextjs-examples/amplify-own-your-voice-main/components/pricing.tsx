...
const plans = [
  {
    ...
    description:
      "Start honing your skills with limited daily practice and core personas.",
    features: [
      "15 mins AI practice / day",
      "3 active sessions",
      "Standard AI feedback",
      "Marketplace browsing",
      "In-browser practice arena",
      "Community support",
    ],
    cta: "Start Free",
  },
  {
    ...
    description: "For professionals and students serious about growth.",
    features: [
      ...
      <div className="flex flex-col items-center justify-center gap-8">
        <div className="flex flex-col items-center space-y-2">
          ...
          >
            ...
            practice sessions and instant communication feedback.
          </motion.p>
        </div>
